...
function VerifyPageContent() {
  ...
  const {
    ...
    enabled: !!betId.trim(), // Auto-fetch when betId is present
    retry: false,
  });
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white/70 p-4 sm:p-6 md:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Input Section */}
        <div className="bg-[#2a2a2a] border border-white/10 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <input
              ...
              className="flex-1 bg-[#1a1a1a] border border-white/20 rounded px-3 sm:px-4 py-2 text-sm sm:text-base text-white focus:outline-none focus:border-green-400"
              onKeyPress={(e) => e.key === "Enter" && handleVerify()}
            />
            <button
              onClick={handleVerify}
              disabled={isVerifying}
              className="w-full sm:w-auto px-6 py-2 bg-green-500 hover:bg-green-600 text-white font-medium rounded disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isVerifying ? (
                <>
          ...
          {error && (
            <div className="mt-3 p-3 bg-red-500/10 border border-red-500/30 rounded text-red-400 text-xs sm:text-sm">
              {error}
            </div>
          )}
        </div>
        ...
        {verificationData && (
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="bg-[#2a2a2a] border border-white/10 rounded-lg p-4 sm:p-6">
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                <div>
                  ...
                  <code className="block mt-1 bg-[#1a1a1a] p-2 rounded font-mono text-[10px] sm:text-xs overflow-x-auto">
                ...
                {verificationData.steps.step0.siweMessage && (
                  <details className="mt-3">
                    ...
                    <pre className="mt-2 bg-[#1a1a1a] p-2 sm:p-3 rounded font-mono text-[10px] sm:text-xs overflow-x-auto whitespace-pre-wrap">
                      {verificationData.steps.step0.siweMessage}
                    </pre>
                  </details>
                )}
                {verificationData.steps.step0.siweSignature && (
                  <details className="mt-3">
                    ...
                    <code className="block mt-2 bg-[#1a1a1a] p-2 rounded font-mono text-[10px] sm:text-xs break-all">
                      {verificationData.steps.step0.siweSignature}
                    </code>
                  </details>
                )}
            ...
            <div className="bg-[#2a2a2a] border border-white/10 rounded-lg p-4 sm:p-6">
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                <div>
                  ...
                  <pre className="mt-1 bg-[#1a1a1a] p-2 sm:p-3 rounded font-mono text-[10px] sm:text-xs overflow-x-auto">
                ...
                <div>
                  ...
                  <code className="block mt-1 bg-[#1a1a1a] p-2 rounded font-mono text-[10px] sm:text-xs break-all">
            ...
            <div className="bg-[#2a2a2a] border border-white/10 rounded-lg p-4 sm:p-6">
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    <div className="bg-[#1a1a1a] p-2 sm:p-3 rounded">
                      ...
                      <code className="block font-mono text-[10px] sm:text-xs break-all">
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    <div className="bg-[#1a1a1a] p-2 sm:p-3 rounded">
                      ...
                      <code className="block font-mono text-[10px] sm:text-xs text-yellow-300">
                ...
                <div>
                  ...
                  <code className="block mt-1 bg-[#1a1a1a] p-2 rounded font-mono text-[10px] sm:text-xs">
            ...
            <div className="bg-[#2a2a2a] border border-white/10 rounded-lg p-4 sm:p-6">
              ...
              {verificationData.steps.step6.requiresTxHash &&
                !verificationData.steps.step6.hasTxHash && (
                  <div className="bg-yellow-500/10 border border-yellow-500/30 rounded p-3 mb-4 text-xs sm:text-sm text-yellow-200">
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                ...
                {verificationData.steps.step6.hasTxHash && (
                  <div className="mt-3 p-2 sm:p-3 bg-[#1a1a1a] rounded space-y-3">
                    <div>
                      <span className="text-white/50 text-[10px] sm:text-xs">
                        Expected Payout (calculated from bet):
                      </span>
                      <code className="block mt-1 bg-[#0a0a0a] p-2 rounded font-mono text-[10px] sm:text-xs overflow-x-auto">
